...
using CrudFornecedores.Domain.Models.Validations;
using System;
using System.Linq;
using System.Threading.Tasks;


namespace CrudFornecedores.Domain.Services
{
    public class FornecedorService : BaseService, IFornecedorService
    {
        ...
        public async Task<bool> Remover(Guid id)
        {
            ...
            {
                Notificar("O fornecedor possui produtos cadastrados, não é possivel excluir ele.");
                return false;
            }
