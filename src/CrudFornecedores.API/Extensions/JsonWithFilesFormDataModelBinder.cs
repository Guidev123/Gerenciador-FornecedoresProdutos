...
namespace CrudFornecedores.API.Extensions
{
    public class JsonWithFilesFormDataModelBinder : IModelBinder
    {
        ...
        public JsonWithFilesFormDataModelBinder(IOptions<JsonOptions> jsonOptions, ILoggerFactory loggerFactory)
        {
            ...
            _formFileModelBinder = new FormFileModelBinder((ILoggerFactory)loggerFactory.CreateLogger<FormFileModelBinder>());
        }
        ...
        public async Task BindModelAsync(ModelBindingContext bindingContext)
        {
            ...
            var model = JsonSerializer.Deserialize(rawValue, bindingContext.ModelType, _jsonOptions);
